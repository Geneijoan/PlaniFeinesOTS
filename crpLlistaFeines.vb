...
Public Class crpLlistaFeines
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PlaniFeinesOTS.crpLlistaFeines.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pTexteCab() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpLlistaFeines
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpLlistaFeines = New crpLlistaFeines()
        rpt.Site = Me.Site
        Return rpt
    End Function
