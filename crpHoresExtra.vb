...
Public Class crpHoresExtra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PlaniFeinesOTS.crpHoresExtra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpHoresExtra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpHoresExtra = New crpHoresExtra()
        rpt.Site = Me.Site
        Return rpt
    End Function
